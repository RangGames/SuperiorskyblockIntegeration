...
public final class GatewayPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        application = new GatewayApplication(this, configuration, redisManager, messages);
        application.start();
        getLogger().info("SuperiorSkyblock gateway component started");
    }
    ...
    public void onDisable() {
        if (application != null) {
            try {
                ...
                getLogger().log(Level.WARNING, "Error while stopping gateway application", ex);
            }
        }
